  ...
  <script>
    function check_input(){
      if (!document.board_modify_form.subject.value){
          header("location: board_modify_form.php?error=제목을 입력하세요.");
          document.board_modify_form.subject.focus();
          return;
      }
      if (!document.board_modify_form.content.value){
        header("location: board_modify_form.php?error=내용을 입력하세요.");
...
?>
          <form  name="board_modify_form" method="post" action="board_dui.php">
