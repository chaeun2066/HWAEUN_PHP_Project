  ...
  <script>
    function check_input(){
      if (!document.event_form.subject.value){
          header("location: event_form.php?error=제목을 입력하세요.");
          document.event_form.subject.focus();
          return;
      }
      if (!document.event_form.content.value){
        header("location: event_form.php?error=내용을 입력하세요.");
...
?>
          ...
          <form  name="event_form" method="post" action="event_dui.php" enctype="multipart/form-data">
          ...
          <div>
            ...
            <ul class="buttons">
              ...
              <li><button type="button" onclick="location.href='event_list.php'" class="green_button">목록</button></li>
            </ul>
          </div>	    	
          </form>
        </div>
