...
<?php
                if (strpos($file_type, "image") !== false) {
                  ...
                  // echo "▷ 첨부파일 : $file_name &nbsp;&nbsp;&nbsp;&nbsp;
                  // <a href='board_download.php?file_name=$file_name&file_type=$file_type'>[저장]</a><br><br>";
...
<?php
                ...
                if($id == 'admin'){
                  echo "
                  <li class=\"inline\">
                    <form class=\"inline\" action=\"event_modify_form.php\" method=\"POST\">
                  ...
                  <li class=\"inline\">
                    <form class=\"inline\" action=\"event_dui.php\" method=\"POST\">
